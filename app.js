(function () {
  ...
  function init() {
    ...
    // Ukur ulang setelah layout benar-benar settle (bukan cuma sekali di
    // tengah render pertama) -- ini yang memperbaiki bug overflow saat
    // pertama kali halaman dibuka, karena clientWidth/clientHeight panel
    // pratinjau kadang belum akurat di frame render paling awal.
    applyFrameSize();
    requestAnimationFrame(function () {
      requestAnimationFrame(applyFrameSize);
    });
    window.addEventListener("load", applyFrameSize);
